...
// Investigation workspace (PR 24B §14, §15, §17, §18).
//
// The workspace route owns the authoritative Investigation detail query
// (with bounded polling), the persistent header and the workspace tabs,
// and provides the detail state to child routes through the router outlet
// context so children never duplicate the polling query.
