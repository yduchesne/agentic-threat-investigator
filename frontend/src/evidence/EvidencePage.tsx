...
// Evidence workspace route (PR 24C §2, §8, §14-§17).
//
// Server-driven browsing: URL-backed exact filters -> bounded keyset page
// -> opaque Previous/Next -> row View -> authoritative Investigation-scoped
// detail drawer. The backend owns filter semantics/order/pagination; the
// browser owns filter form state, URL serialization, cursor navigation,
// selection, and explicit current-page CSV export. Empty evidence never
...
import type { Evidence, EvidenceTypeName } from "../api/schema-types";
